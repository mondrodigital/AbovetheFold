    ...
    <div className="pt-32">
      <div className="max-w-2xl">
        <h1 className="text-[64px] leading-[1.1] font-bold mb-8 tracking-tight">
          We design "Above the Fold" websites that convert visitors in 3 seconds.
        </h1>
        ...
        <div className="flex items-center gap-24">
          <div>
            <p className="text-xl font-semibold mb-2">Projects start at $15,000</p>
            <p className="text-gray-600">2-week delivery. Fixed-price guarantee.</p>
          </div>
